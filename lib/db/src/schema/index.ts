...
export const userPreferences = pgTable(
  "user_preferences",
  {
    ...
    // ── Extended preferences (v2) ──────────────────────────────────────────
    noisePreference: varchar("noisePreference", { length: 16 }),
    energyLevel: integer("energyLevel"),
    flexibilityLevel: integer("flexibilityLevel"),
    idealDuration: integer("idealDuration"),
    avoidRain: boolean("avoidRain").default(false),
    outdoorOnlyGoodWeather: boolean("outdoorOnlyGoodWeather").default(false),
    prefersSunny: boolean("prefersSunny").default(false),
    midpointPreference: boolean("midpointPreference").default(false),
    prioritizeType: varchar("prioritizeType", { length: 32 }),
    avoidVenues: text("avoidVenues"),
